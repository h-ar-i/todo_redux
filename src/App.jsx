...
function App() {
  ...
  return (
    <>
      ...
      >
        <div className="p-4 container mt-5 border border-primary border-5" style={{ backgroundColor: "white", width: "90%" }}>
          <h1 className="mb-4 fw-bolder" style={{textAlign:'center'}}>Todo list</h1>
          <div className="d-flex w-25">
            ...
            />
            <button onClick={addNewTodo} className="btn btn-success ms-2">Add</button>
          </div>
          ...
          <div className="mt-5">
            <h6>Total Complete items : <span style={{fontSize:"15px"}} className="text-success fw-bolder">{chek}</span></h6>
          </div>
        </div>
      </div>
    </>
